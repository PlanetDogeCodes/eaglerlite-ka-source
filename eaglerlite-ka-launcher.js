/* EaglerLite v2.1 KA Launcher JS - external CDN-loaded launcher for the Khan Academy iframe port.
   Loaded via <script src="https://cdn.jsdelivr.net/gh/PlanetDogeCodes/eaglerlite-ka-source@main/eaglerlite-ka-launcher.js?v=2.1.0">.
   ...
   source:'ka-chunks'} to the parent (screenChanged hook + canvas poller, 500ms x 300 tries); a 60s watchdog
   ...
   page. Includes cleanup(), config/profile/theme/timeline/history/banner/kbd systems, per-field guarded DOM
